  ...
  return (
    <MainCarouselWrapper>
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => <ProductsCarouselCard item={item} index={index} />}
        horizontal={true}
      ...
      <CarouselControlsWrapper>
        ...
        {/* indicators */}
        <DotIndicator data={ProductsCarouselData} currentIndex={currentIndex} />
